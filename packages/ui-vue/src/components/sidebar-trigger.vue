...
const toggle = inject<() => void>('sidebar-toggle')!
...
<template>
  <component :is="tag" @click="toggle" :class="cn('inline-flex h-7 w-7 items-center justify-center rounded-md hover:bg-accent print:hidden', props.class)">
