...
<template>
  <component :is="tag" :class="cn('relative flex w-px items-center justify-center bg-border cursor-col-resize', props.class)">
    <div v-if="props.withHandle" class="z-10 flex h-4 w-3 items-center justify-center rounded-sm border bg-border">
