<script lang="ts">
  ...
  let { variant = 'default', open = $bindable(true), class: className = '', children, ...props }: { variant?: string; open?: boolean; class?: string; children?: Snippet; [key: string]: unknown } = $props()
</script>
