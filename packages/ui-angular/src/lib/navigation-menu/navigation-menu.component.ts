...
@Component({ selector: 'paul-navigation-menu-list', standalone: true, template: `<ul class="group flex flex-1 list-none items-center justify-center space-x-1"><ng-content /></ul>`, changeDetection: ChangeDetectionStrategy.OnPush })
