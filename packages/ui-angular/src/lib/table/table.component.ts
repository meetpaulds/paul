...
@Component({ selector: 'paul-table-head', standalone: true, template: `<th scope="col" class="h-10 px-2 text-left align-middle font-medium text-muted-foreground [&:has([role=checkbox])]:pr-0 [&>[role=checkbox]]:translate-y-[2px]"><ng-content /></th>`, changeDetection: ChangeDetectionStrategy.OnPush })
