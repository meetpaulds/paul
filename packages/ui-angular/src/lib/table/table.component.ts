...
@Component({ selector: 'paul-table-header', standalone: true, template: `<thead class="[&_tr]:border-b print:[&_tr]:border-black"><ng-content /></thead>`, changeDetection: ChangeDetectionStrategy.OnPush })
export class TableHeaderComponent {}

@Component({ selector: 'paul-table-body', standalone: true, template: `<tbody class="[&_tr:last-child]:border-0 print:border-black"><ng-content /></tbody>`, changeDetection: ChangeDetectionStrategy.OnPush })
export class TableBodyComponent {}

@Component({ selector: 'paul-table-footer', standalone: true, template: `<tfoot class="border-t bg-muted/50 font-medium [&>tr]:last:border-b-0 print:border-black"><ng-content /></tfoot>`, changeDetection: ChangeDetectionStrategy.OnPush })
